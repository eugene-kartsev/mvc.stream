    ...
    namespace Adstream.Web.Common.test
    {
        ...
        public class ResumeFileResultTests : BaseTests
        {
            ...
            public void Range_First_500b()
            {
                ...
                Assert.AreEqual(string.Format("bytes 0-499/{0}", _file.Length),
            ...
            public void Range_From_500b_to_899b()
            {
                ...
                Assert.AreEqual(206, Response.StatusCode);
                Assert.AreEqual(string.Format("bytes 500-899/{0}", _file.Length),
                                Response.Headers[HttpHeaders.ContentRange]);
            }
            ...
            public void Range_Last_300b()
            {
                ...
                Assert.AreEqual(string.Format("bytes {0}-{1}/{2}", from, to, _file.Length),
                                Response.Headers[HttpHeaders.ContentRange]);
            }
            ...
            {
                var stream = GetResponseStream(string.Format("bytes={0}-", (_file.Length - 100)));
            ...
            public void Range_First_1b()
            {
                ...
                Assert.AreEqual(206, Response.StatusCode);
                Assert.AreEqual(string.Format("bytes 0-0/{0}", _file.Length),
                                Response.Headers[HttpHeaders.ContentRange]);
            }
            ...
            public void Range_Whole_File_With_RangeHeader()
            {
                ...
                //TODO: check this
                Assert.AreEqual(206, Response.StatusCode);
                Assert.AreEqual(string.Format("bytes 0-{0}/{1}", (_file.Length - 1), _file.Length),
                                Response.Headers[HttpHeaders.ContentRange]);
            }
